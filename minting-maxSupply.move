...
module mint_nft::minting {
   ...
   //  friend aptos_framework::aptos_coin;
    ...
    ///MINT FEE
  //  let MINT_FEE: u64 = 100000; //IN OCTAS
    //FEE RECEIVER
  //  let FEE_RECEIVER: address = x"6989caf1f19cb6cead7eb0eb5a3632f1431433bf745e337966623674a432bbea";
    ...
    fun init_module_with_admin_public_key(resource_account: &signer, pk_bytes: vector<u8>) {
        let collection_name = string::utf8(b"Aptos NFT");
        ...
        let token_uri = string::utf8(b"www.aptos.com/");
        let expiration_timestamp = 1668522126;
        //add mint fee here
        let mint_fee = 1000000;
        // add fee receiver address here
        let fee_receiver_address = @0xcad6bc4b4a31bd43de980e2e92548d47d2be7c2dcc90d7aefe5ae51aec8e134d;
    ...
    public entry fun mint_nft(receiver: &signer) acquires ModuleData {
        ...
        //  assert!(token_id != module_data.maximum_supply, error::permission_denied(MAX_SUPPLY_REACHED));
        ...
        aptos_account::transfer(receiver, module_data.fee_receiver_address, module_data.mint_fee);
    ...
    // //withdraw function seld added
    //     fun withdrawAmount<CoinType>(sender: &signer,amount: u64) {
